...
import com.example.polls.exception.BadRequest;
...
public class PollService {
    ...
    public PollResponse castVoteAndGetUpdatedPoll(Long pollId, VoteRequest voteRequest, UserPrincipal currentUser) {
        ...
        try {
            ...
            throw new BadRequest("Sorry! You have already cast your vote in this poll");
        }
    ...
    private void validatePageNumberAndSize(int page, int size) {
        if(page < 0) {
            throw new BadRequest("Page number cannot be less than zero.");
        }

        if(size > AppConstants.MAX_PAGE_SIZE) {
            throw new BadRequest("Page size must not be greater than " + AppConstants.MAX_PAGE_SIZE);
        }
    }
